...
API_ID = 18620170
API_HASH = '56af6ff11bcb12cc4d3122617c8350d0'

PRIVATE_PUBLIC = 'testapp2001'  # скрытый паблик для управления ботом
PUBLIC_PUBLIC = 'freebettingtips_01'  # паблик куда будем репостить
SOURCE_PUBLICS = [
    # список пабликов-доноров, откуда бот будет пересылать посты
    'dan_trump',
    'dfsdhog',
]
PHONE_NUMBER = '+79533584919'  # номер зарегистрованный в телеге
